    ...
    <div className="shadow-lg relative rounded-3xl border p-3 flex flex-col text-indigo-900">
      ...
      <div className="h-52 w-full mb-2">
        <img
          ...
          alt={product.model}
          loading="lazy"
          className="h-[208px] w-full object-cover object-center bg-[#eff6f6] rounded-xl shadow"
        />
      </div>
      <h1 className="font-bold text-center overflow-hidden text-ellipsis whitespace-nowrap" title={product.model}>{product.model}</h1>
